...
class AlipaySubmit {
	...
	function __construct($alipay_config, $alipay_gateway = null){
		$this->alipay_config = $alipay_config;
        if(!is_null($alipay_gateway)){
		    $this->alipay_gateway_new = $alipay_gateway;
        }
	}
    function AlipaySubmit($alipay_config, $alipay_gateway = null) {
    	$this->__construct($alipay_config, $alipay_gateway);
    }
